# -*- coding: utf-8 -*-
"""
IB API - Opening Range Breakout strategy - Homework Solution
...
tickers = [] #ticker list would be updated by the scannerDara wrapper function
pos_size = 3000
profit_limit = 1000
loss_limit = -500
...
##### wrapper function for reqScannerSubscription. this function handles scanner output           
    def scannerData(self, reqId, rank, contractDetails, distance, benchmark, projection, legsStr):
        ...
        tickers.append(contractDetails.contract.symbol)
...
####  this function returns the required object of scanner class  
def usStkScan(asset_type="STK",asset_loc="STK.NASDAQ",scan_code="HIGH_OPEN_GAP"):
    ...
    scan_obj.marketCapAbove = 800000000 #IBAPI does not multiply the number with million
    scan_obj.changeOpenPercAbove = 3
    scan_obj.changeOpenPercBelow = 6
    scan_obj.abovePrice = 15
    scan_obj.openGapPercAbove = 5
    return scan_obj
